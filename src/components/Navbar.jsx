...
const Navbar = () => {
    ...
    return (
        <div className='flex justify-between items-center px-8 opacity-95 sticky top-0 z-50'>
            <div className='flex items-center h-6 gap-x-8 relative '>
                <div className=' h-full'>
                    <div className=' h-full flex flex-col items-center justify-center'>
                        <div className='bg-white w-5 h-[1px] mb-1.5'/>
                        <div className='bg-white w-5 h-[1px] mb-1.5'/>
                        <div className='bg-white w-5 h-[1px]'/>
                    </div>
                </div>

                <Link to={`/`}>
                    <div className='w-[6.2rem] h-full'>
                        <svg viewBox="0 0 90 20" className='relative '>
                            <g>
                        ...
                        <p className='absolute -right-3 -top-2 text-white text-[.7rem]'>IN</p>
                    </div>
                </Link>
            </div>

            {showSearchBar && (
                <div className=' w-[35%] flex items-center gap-x-4'>
            ...
            <div className='flex items-center gap-x-6'>
                {!showSearchBar && (
                    <>
                        <div className='flex gap-x-6 items-center justify-center'>
                            <IoIosSearch className=' cursor-pointer w-[1.32rem] h-[1.32rem]'/>
                            {hideIconInMobile && (
                                <FaMicrophone className=' cursor-pointer w-[1.32rem] h-[1.32rem]'/>
                            )}
                        </div>
                    </>
                )}

                <div className='cursor-pointer' onClick={() => setCreateIconColor(!createIconColor)}>
                    <svg viewBox="0 0 24 24" width="24" focusable="false">
                        <path d="M14 13h-3v3H9v-3H6v-2h3V8h2v3h3v2zm3-7H3v12h14v-6.39l4 1.83V8.56l-4 1.83V6m1-1v3.83L22 7v8l-4-1.83V19H2V5h16z" fill={`${createIconColor ? '#FFFF' : '#FFFF'}`}/>
                    </svg>
                </div>
                ...
                {hideIconInMobile && (
                    <div className='relative cursor-pointer'>
                        <svg viewBox="0 0 24 24" width="24" focusable="false" >
                            <path d="M10 20h4c0 1.1-.9 2-2 2s-2-.9-2-2zm10-2.65V19H4v-1.65l2-1.88v-5.15C6 7.4 7.56 5.1 10 4.34v-.38c0-1.42 1.49-2.5 2.99-1.76.65.32 1.01 1.03 1.01 1.76v.39c2.44.75 4 3.06 4 5.98v5.15l2 1.87zm-1 .42-2-1.88v-5.47c0-2.47-1.19-4.36-3.13-5.1-1.26-.53-2.64-.5-3.84.03C8.15 6.11 7 7.99 7 10.42v5.47l-2 1.88V18h14v-.23z" fill='#FFFF'/>
                        </svg>

                        <div className="absolute -top-1 -right-3 bg-red-700 rounded-full text-white text-[12px] px-1 flex items-center justify-center">
                            1+
                        </div>
                    </div>
                )}
